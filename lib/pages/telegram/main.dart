import 'package:allhomework/pages/telegram/chat_list.dart';
import 'package:allhomework/pages/telegram/chat_model.dart';
import 'package:allhomework/pages/telegram/chat_page.dart';
import 'package:allhomework/pages/telegram/drawer.dart';
        ...
        return ListTile(
          ...
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (_) => TelegramChatPage(chat,_size)));
          },
        );
      });
